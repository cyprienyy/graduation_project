...
if __name__ == '__main__':
    ...
    _cor = get_soloman_cor(r'TempFiles\R101.txt')
    ...
    # [3, 21, 22], [1, 2] + list(range(4, 21)) + [23, 24, 25]
    imp_ga_r = [[0, 12, 3, 9, 24, 12, 12, 22, 23, 25, 4, 4, 21, 2, 13, 6, 17, 16, 14, 15, 22, 12, 0], [0, 10, 20, 1, 18, 5, 8, 7, 19, 11, 10, 0]]
    ga_r = [[0, 22, 12, 24, 4, 21, 13, 6, 16, 14, 15, 15, 2, 25, 23, 22, 12, 0], [0, 12, 10, 11, 19, 7, 7, 8, 17, 5, 18, 1, 3, 9, 20, 10, 12, 0]]
    ant_r = [[0, 12, 1, 20, 9, 3, 24, 25, 4, 21, 12, 10, 11, 19, 7, 18, 8, 17, 16, 5, 10, 0], [0, 22, 23, 21, 2, 13, 6, 5, 14, 15, 22, 0]]
    draw_route(_cor, 0, [10, 12, 22], list((range(1, 10))) + [11] + list(range(13, 22)) + [23, 24, 25], ant_r)
